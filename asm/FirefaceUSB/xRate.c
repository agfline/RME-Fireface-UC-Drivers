...
*/
	if ( edi < 0x2cf88 ) /* 184200 */
	{
		return 0x2b110;							/* 176400 Hz */
	}
	else
	{
		return 0x2ee00;							/* 192000 Hz */
	}
/*
	0x00001b2a  pop  rbp
	0x00001b2b  ret
